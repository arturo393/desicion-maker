# 🎲 Decision Maker - Framework Monte Carlo para Decisiones

> Un framework genérico en C++17 para simulaciones Monte Carlo aplicado a la toma de decisiones en cualquier dominio.
