...
def main():
    ...
    print(f"\n   💰 Análisis Financiero:")
    print(f"   - Salario actual: $2,600,000")
    print(f"   - Salario minería: $4,500,000")
    ...
    print(f"\n   📅 Timeline:")
    print(f"   - Duración plan: 12 semanas (3 meses)")
    ...
    if mining_result.overall_score > uqomm_result.overall_score:
        print(f"   ✅ Minería es mejor que UQOMM actual")
    else:
        print(f"   ⚠️  UQOMM actual es más seguro")
