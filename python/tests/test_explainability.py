...
def mc_results():
    ...
    return {
        "OptionA": Statistics(
            option_name="OptionA",
            mean_score=0.6, std_dev=0.1,
            min_score=0.5, max_score=0.95,
            percentile_5=0.6, percentile_95=0.9,
            success_rate=0.9,
            factor_stats={
        ...
        "OptionB": Statistics(
            option_name="OptionB",
            mean_score=0.4, std_dev=0.15,
            min_score=0.3, max_score=0.85,
            percentile_5=0.4, percentile_95=0.8,
            success_rate=0.7,
            factor_stats={
...
class TestExplainabilityEngine:
    ...
    def test_counterfactual_single_option(self, factors):
        results = {
            "Only": Statistics(
                "Only", 10, 0, 10, 10, 10, 10, 1.0, {"X": {"mean": 10}}, 10, 10,
            ),
        }
    ...
    def test_narrative_includes_winner(self, mc_results, factors, topsis_scores):
        ...
        text = self.engine.narrative(
            mc_results, factors, waterfall, counterfactual, topsis_scores
        )
