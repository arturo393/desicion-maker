...
def research_leaky_feeder_monitoring():
    ...
    print(f"Iniciando investigación profunda...\n")
    print("-"*80)
    ...
    try:
        ...
        print(f"⏳ Esperando resultados (esto puede tomar varios minutos)...\n")
        ...
        while True:
            ...
            if interaction.status == "completed":
                ...
                with open(output_file, 'w', encoding='utf-8') as f:
                    ...
                    f.write(f"**Modelo:** deep-research-pro-preview-12-2025\n")
