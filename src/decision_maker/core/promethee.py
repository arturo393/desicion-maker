"""
PROMETHEE outranking method engine for preference-based decision option ranking.
Usage: from decision_maker.core.promethee import PrometheeEngine
Does NOT: Run Monte Carlo stochastic sampling.
"""
