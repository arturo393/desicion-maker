...
class SensitivityEngine:
    ...
    def analyze(mc_results: dict[str, Statistics], factors: list[Factor]) -> dict[str, Any]:
        ...
        raw_scores = {name: {k: v["mean"] for k, v in stats.factor_stats.items()} for name, stats in mc_results.items()}
        ...
        sensitivity_report["robustness_score"] = 1.0 - (total_changes / total_checks) if total_checks > 0 else 1.0
